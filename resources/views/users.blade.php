...
<body  class="d-flex flex-column min-vh-100">
    ...
    @include('components-user.modal-create')
    ...
    var table = $('#myTable').DataTable({
        ...
        columns: [
            ...
            { data: 'username_user', name: 'username_user', orderable: true, searchable: true },
            { data: 'nama_user', name: 'nama_user', orderable: true, searchable: true },
            { data: 'alamat_user', name: 'alamat_user', orderable: true, searchable: true },
            { data: 'nomor_telp', name: 'nomor_telp', orderable: true, searchable: true },
    ...
    $('#myTable').on('click', '.delete', function() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    url: "/user/" + id_user, // Sesuaikan dengan rute delete Anda
                    type: "DELETE",
                    data: {
